(function (global, factory) {
	...
	function setupHiDefCanvas(canvas) {
	  ...
	  console.log("ratio = " + ratio); // Get the size of the canvas in CSS pixels.
	  ...
	  ctx.scale(ratio, ratio); // and we shrink the display size using CSS
	...
	var Node = /*#__PURE__*/function () {
	  ...
	  _createClass(Node, [{
	    ...
	    value: function draw(ctx) {
	      ctx.beginPath(); //      ctx.fillStyle = "darkGrey";
	  ...
	  _createClass(ForceDirected, [{
	    ...
	    value: function applyForcesExertedByConnections() {
	      ...
	      this.graph.linkList.forEach(function (link) {
	        var node1 = _this2.graph.nodeList[link.source];
	        var node2 = _this2.graph.nodeList[link.target]; //let maxDis = con[2];
	    ...
	    value: function updateNodesVelocity() {
	      this.graph.nodeList.forEach(function (node) {
	        var force_copy = node.force.copy();
	        var velocity = force_copy.div(node.mass);
