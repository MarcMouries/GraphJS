(function (global, factory) {
	...
	function setupHiDefCanvas(canvas) {
	  ...
	  var ctx = canvas.getContext("2d"); // Get the size of the canvas in CSS pixels.
	...
	var Node = /*#__PURE__*/function () {
	  function Node(id, data) {
	    ...
	    this.radius = this.size; //this.force = new Vector(0, 0);
	...
	var ForceDirected = /*#__PURE__*/function () {
	  ...
	  _createClass(ForceDirected, [{
	    ...
	    key: "applyForce",
	    value: function applyForce(node, force) {
